...
As configurações realizadas através dos comandos no git são incluídas no arquivo citado acima.
...
Mais [Git Book](http://git-scm.com/book/en/Git-Basics-Viewing-the-Commit-History)
...
Mais  [Rebasing](http://git-scm.com/book/en/Git-Branching-Rebasing)
